...
class Paginas extends Controllers{
	...
	public function paginas()
	{
		...
		$data['page_title'] = "PÁGINAS <small>Tienda Danper</small>";
	...
	public function editar($idpost){
		...
		if($idpost > 0){
			...
			$data['page_title'] = "ACTUALIZAR PÁGINA <small>Tienda Danper</small>";
	...
	public function crear(){
		...
		$data['page_title'] = "CREAR PÁGINA <small>Tienda Danper</small>";
