...
class Pedidos extends Controllers{
	...
	public function Pedidos()
	{
		...
		$data['page_title'] = "PEDIDOS <small>Tienda Danper</small>";
	...
	public function orden($idpedido){
		...
		$data['page_title'] = "PEDIDO <small>Tienda Danper</small>";
	...
	public function transaccion($transaccion){
		...
		$data['page_tag'] = "Detalles de la transacción - Tienda Danper";
